...
<title>My Applications — Smart Campus Placement</title>
        ...
        <div class="page-content">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-info"><div class="stat-label">Upcoming Interviews</div><div class="stat-value"><%= interviewCount %></div></div>
                </div>
            </div>
            ...
            <div class="content-card">
                <div class="content-card-header">
                    ...
                    <span class="badge-pill badge-teal"><%= applicaCount %> total</span>
                </div>
                <div class="content-card-body">
                    ...
                    <div class="empty-state">
                        ...
                        <p>You haven't applied to any jobs yet. <a href="Student-Dashboard.jsp" style="color:#5EB1BF;">Browse available jobs.</a></p>
                    </div>
                    <% } else { %>
                    <div class="items-grid">
                        <% for (Application applins : list) {
                            String status = applins.getStatus().toLowerCase();
                            String badgeClass = "badge-neutral";
                            if (status.contains("pending")) badgeClass = "badge-warning";
                            if (status.contains("select") || status.contains("accept")) badgeClass = "badge-success";
                            if (status.contains("reject")) badgeClass = "badge-danger";
                        %>
                        <div class="item-card">
                            <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:8px;">
                                <div class="item-title"><%= applins.getCompanyName() %></div>
                                <span class="badge-pill <%= badgeClass %>"><%= applins.getStatus() %></span>
                            </div>
                            <div style="font-size:0.85rem;margin-bottom:8px;color:#475569;">
                                <strong>Role:</strong> <%= applins.getJobDescription() %>
                            </div>
                            <div class="item-meta">
                                <span>
