...
<div class="portal-wrapper">
    <aside class="sidebar admin-sidebar-bg">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="manageStudents.jsp" class="active" id="nav-students"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4.26 10.147a60.438 60.438 0 0 0-.491 6.347A48.62 48.62 0 0 1 12 20.904a48.62 48.62 0 0 1 8.232-4.41 60.46 60.46 0 0 0-.491-6.347m-15.482 0a50.636 50.636 0 0 0-2.658-.813A59.906 59.906 0 0 1 12 3.493a59.903 59.903 0 0 1 10.399 5.84c-.896.248-1.783.52-2.658.814" /></svg>Students</a>
    ...
    <div class="main-area">
        <div class="topbar">
            <div class="topbar-left"><div style="font-size:1rem;font-weight:700;color:#042A2B;">Manage Students</div></div>
        ...
        <div class="page-content">
            <div class="page-header">
                ...
                <p>View and manage all registered students — <%= students != null ? students.size() : 0 %> total</p>
            </div>
            ...
            <div class="content-card">
                <div class="content-card-header">
                    ...
                    <span class="badge-pill badge-teal"><%= students != null ? students.size() : 0 %> registered</span>
                </div>
                ...
                <div class="content-card-body">
                    <div class="empty-state">
                        ...
                        <p>Students who register on the platform will appear here.</p>
                    </div>
                </div>
                <% } else { %>
                            ...
                            <tr>
                                <td>
                                    <div style="display:flex;align-items:center;gap:10px;">
                                        <div style="width:32px;height:32px;border-radius:50%;background:var(--accent-light);display:flex;align-items:center;justify-content:center;font-size:0.85rem;font-weight:700;color:var(--primary);flex-shrink:0;">
                                            <%= s.getFullName().substring(0,1).toUpperCase() %>
                                        </div>
                                        <span style="font-weight:600;"><%= s.getFullName() %></span>
                                    </div>
                                </td>
                                <td><%= s.getBranch() %></td>
                                <td><span class="badge-pill badge-teal"><%= s.getCgpa() %></span></td>
                                <td style="color:#475569;"><%= s.getEmail() %></td>
                                <td style="color:#475569;"><%= s.getPhone() %></td>
                                <td>
                                    <a href="DeleteStudentServlet?id=<%= s.getStudentId() %>" class="btn-portal btn-portal-danger btn-portal-sm"
                                       onclick="return confirm('Delete student <%= s.getFullName() %>? This cannot be undone.')">
