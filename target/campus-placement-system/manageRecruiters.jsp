...
List<Recruiter> list = dao.getAllRecruiters();
%>
...
<title>Manage Recruiters — Admin</title>
...
<div class="portal-wrapper">
    ...
    <div class="main-area">
        <div class="topbar">
            <div class="topbar-left"><div style="font-size:1rem;font-weight:700;color:#042A2B;">Manage Recruiters</div></div>
        ...
        <div class="page-content">
            <div class="page-header">
                ...
                <p>View and manage all registered companies — <%= list != null ? list.size() : 0 %> total</p>
            </div>
            ...
            <div class="content-card">
                <div class="content-card-header">
                    ...
                    <span class="badge-pill badge-info"><%= list != null ? list.size() : 0 %> companies</span>
                </div>
                <% if(list == null || list.isEmpty()) { %>
                <div class="content-card-body">
                    <div class="empty-state">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 21h16.5M4.5 3h15M5.25 3v18m13.5-18v18M9 6.75h1.5m-1.5 3h1.5m-1.5 3h1.5m3-6H15m-1.5 3H15m-1.5 3H15M9 21v-3.375c0-.621.504-1.125 1.125-1.125h3.75c.621 0 1.125.504 1.125 1.125V21" /></svg>
                        <h5>No recruiters registered yet</h5>
                        <p>Companies who register on the platform will appear here.</p>
                    </div>
                </div>
                <% } else { %>
                            ...
                            <tr>
                                <td>
                                    <div style="display:flex;align-items:center;gap:10px;">
                                        <div style="width:32px;height:32px;border-radius:8px;background:#dbeafe;display:flex;align-items:center;justify-content:center;font-size:0.85rem;font-weight:700;color:#1e3a8a;flex-shrink:0;">
                                            <%= r.getCompanyName().substring(0,1).toUpperCase() %>
                                        </div>
                                        <span style="font-weight:600;"><%= r.getCompanyName() %></span>
                                    </div>
                                </td>
                                <td><%= r.getHrName() %></td>
                                <td style="color:#475569;"><%= r.getEmail() %></td>
                                <td style="color:#475569;"><%= r.getPhone() %></td>
                                <td>
                                    <a href="DeleteRecruiterServlet?id=<%= r.getRecruiterId() %>" class="btn-portal btn-portal-danger btn-portal-sm"
                                       onclick="return confirm('Delete recruiter <%= r.getCompanyName() %>?')">
